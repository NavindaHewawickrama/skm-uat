...
const ProcessingOrdersPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchProcessingOrderData = async () => {
            try {
                const response = await fetch(`/api/orders/processing`, {
                    method: "GET",
                    credentials: "include",
                });
    ...
    // Fetch pending order data from API for notiifications
    useEffect(() => {
                    ...
                    <div className="flex-1 flex items-center justify-center">
                        <div className="text-center">
                            ...
                            <p className="mt-4 text-lg text-gray-600">
                                Loading processing orders data...
                            </p>
                        </div>
                    </div>
                </div>
